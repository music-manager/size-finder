        ...
        <div>
          ...
          <div className="mt-5">
            ...
            <a
              ...
              className="mt-2.5 flex w-full items-center justify-center gap-1.5 rounded-xl bg-brand-600 py-3.5 text-sm font-bold text-white transition hover:bg-brand-700 active:scale-[0.99]"
            >
              쿠팡에서 보기
